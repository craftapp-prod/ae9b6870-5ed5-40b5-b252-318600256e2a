...
export default function MiniPlayer() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8" data-path="frontend/src/app/page.tsx" id="el_769c59d3">
      <div className="max-w-4xl mx-auto" data-path="frontend/src/app/page.tsx" id="el_aa920b74">
        <div className="text-center mb-12" data-path="frontend/src/app/page.tsx" id="el_66ec7d8d">
          <h1 className="text-4xl font-bold text-gray-900 mb-4" data-path="frontend/src/app/page.tsx" id="el_6f478c2e">MiniPlayer</h1>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden" data-path="frontend/src/app/page.tsx" id="el_9c674b64">
          <div
            ...
            onMouseMove={handleMouseMove} data-path="frontend/src/app/page.tsx" id="el_3037d53f">

            {!videoUrl ?
            <div className="absolute inset-0 flex items-center justify-center bg-gray-100" data-path="frontend/src/app/page.tsx" id="el_0aea084c">
                <div className="text-center p-8" data-path="frontend/src/app/page.tsx" id="el_fdfa6b03">
                  ...
                  <div className="relative" data-path="frontend/src/app/page.tsx" id="el_9ed7f65f">
                    ...
                    {uploadError &&
                  <p className="mt-2 text-sm text-red-600" data-path="frontend/src/app/page.tsx" id="el_9a040d71">{uploadError}</p>
                  }
                  </div>
                </div>
              </div> :
            ...
            <>
                ...
                onEnded={() => setIsPlaying(false)} data-path="frontend/src/app/page.tsx" id="el_b1327e8c" />


                {/* Controls overlay */}
                {showControls &&
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex flex-col justify-between p-4" data-path="frontend/src/app/page.tsx" id="el_734d813c">
                    {/* Top controls */}
                    ...
                    <div className="flex flex-col gap-2" data-path="frontend/src/app/page.tsx" id="el_13c6c166">
                      ...
                      className="p-2 text-white bg-black/50 rounded-full hover:bg-black/70 transition-colors" data-path="frontend/src/app/page.tsx" id="el_f292f67f">
                      ...
                      <Play className="w-5 h-5" />
                        ...
                        value={currentTime}
                        onChange={handleSeek}
                        className="w-full h-1" data-path="frontend/src/app/page.tsx" id="el_e31ef7e0" />

                        </div>

                        <button
                      onClick={toggleMute}
                      className="p-2 text-white bg-black/50 rounded-full hover:bg-black/70 transition-colors" data-path="frontend/src/app/page.tsx" id="el_8fdfae67">
                      ...
                      <Volume2 className="w-5 h-5" />
                        ...
                        className="w-full h-1" data-path="frontend/src/app/page.tsx" id="el_c013d46d" />

                        </div>

                        <button
                      onClick={toggleFullscreen}
                      className="p-2 text-white bg-black/50 rounded-full hover:bg-black/70 transition-colors" data-path="frontend/src/app/page.tsx" id="el_8dd1bbe7">
        ...
        <div className="mt-12 bg-white rounded-xl shadow-lg p-8" data-path="frontend/src/app/page.tsx" id="el_3068e530">
          ...
          <div className="flex justify-center" data-path="frontend/src/app/page.tsx" id="el_42e4969d">
            <label className="inline-flex h-12 items-center justify-center rounded-md bg-primary-600 px-8 text-sm font-medium text-white shadow transition-colors hover:bg-primary-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 cursor-pointer" data-path="frontend/src/app/page.tsx" id="el_df3b035f">
              ...
              <input
                ...
                accept="video/*"
                onChange={handleFileUpload}
                className="hidden" data-path="frontend/src/app/page.tsx" id="el_9918df59" />
